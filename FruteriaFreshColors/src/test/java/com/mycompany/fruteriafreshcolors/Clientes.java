...
public class Clientes  extends Catalogos{
    ...
    public Clientes(String identificacion, String nombreProvedor, String apellidos, String ciudad, String direccion, String telefono, String correo, String estado) {
